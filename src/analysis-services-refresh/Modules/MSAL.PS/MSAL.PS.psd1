...
NestedModules = @('.\Clear-MsalCache.ps1', 
...
FunctionsToExport = 'Clear-MsalCache', 'Get-MsalAccount', 'Get-MsalClientApplication', 
...
FileList = '.\Clear-MsalCache.ps1', 
               '.\ConvertFrom-SecureStringAsPlainText.ps1', 
               '.\Get-MsalAccount.ps1', '.\Get-MsalClientApplication.ps1', 
               '.\Get-MsalToken.ps1', '.\License.txt', '.\MSAL.PS.ps1', 
               '.\MSAL.PS.psd1', '.\MSAL.PS.psm1', '.\New-MsalClientApplication.ps1', 
               '.\Select-PsBoundParameters.ps1', 
